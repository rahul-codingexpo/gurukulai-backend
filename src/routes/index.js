...
import idCardTemplateRoutes from "../modules/school/idCardTemplate.routes.js";
...
import examAttendanceRoutes from "../modules/exam/examAttendance.routes.js";
...
import studentFeeDiscountRoutes from "../modules/accounting/studentFeeDiscount.routes.js";
const router = express.Router();

router.use("/auth", authRoutes);
router.use("/users", userRoutes);
router.use("/schools", schoolRoutes);
router.use("/school/id-card-template", idCardTemplateRoutes);
...
router.use("/academic/exam-attendance", examAttendanceRoutes);
...
router.use(studentFeeDiscountRoutes);
